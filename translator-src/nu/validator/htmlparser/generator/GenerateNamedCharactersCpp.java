...
public class GenerateNamedCharactersCpp {
    ...
    private static void generateH(File targetDirectory, CppTypes cppTypes, Map<String, String> entities) throws IOException {
        File hFile = new File(targetDirectory, cppTypes.classPrefix() + "NamedCharacters.h");
        ...
        out.write("{\n");
        out.write("  public:\n");
        out.write("    static " + cppTypes.arrayTemplate() + "<" + cppTypes.arrayTemplate() + "<" + cppTypes.charType() + "," + cppTypes.intType() + ">," + cppTypes.intType() + "> NAMES;\n");
        out.write("    static " + cppTypes.arrayTemplate() + "<" + cppTypes.charType() + "," + cppTypes.intType() + ">* VALUES;\n");
    ...
    private static void generateCpp(File targetDirectory, CppTypes cppTypes, Map<String, String> entities) throws IOException {
        ...
        out.write("    WINDOWS_1252[i] = &(WINDOWS_1252_DATA[i]);\n");
        out.write("  }\n");
        out.write("}\n");
        out.write("\n");
        out.write("void\n");
